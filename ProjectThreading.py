...
import Motor_Logic.py, detect.py, timer_clr_sz_snr.py, spi_12_mean.py, timer_ing_cap.py
# import utility.py # uncomment if needed

Thread(target=timer_ing_cap.py).start() # takes image for color and size code
